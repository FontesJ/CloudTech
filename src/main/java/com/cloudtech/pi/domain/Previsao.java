...
public class Previsao extends AbstractEntity<Long>{
    ...
    @Column(name = "texto", nullable = false, unique = true, length = 200)
    private String texto;
    @Column(name = "seriedade", nullable = false, unique = true, length = 60)
    private long seriedade;
    @Column(name = "maxima", nullable = false, unique = true, length = 60)
    private int maxima;
    @Column(name = "minima", nullable = false, unique = true, length = 60)
    private int minima;
